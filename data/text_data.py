...
total_stat_map = {'field goals per game': 'fg_per_g', 'field goal attempts per game': 'fga_per_g', 'field goal percentage': 'fg_pct', '3-point field goals per game': 'fg3_per_g', '3-point field goal attempts per game': 'fg3a_per_g', '3-point field goal percentage': 'fg3_pct', '2-point field goals per game': 'fg2_per_g', '2-point field goal attempts per game': 'fg2a_per_g', '2-point field goal percentage': 'fg2_pct', '<strong>effective field goal percentage</strong><br>this statistic adjusts for the fact that a 3-point field goal is worth one more point than a 2-point field goal.': 'efg_pct', 'free throws per game': 'ft_per_g', 'free throw attempts per game': 'fta_per_g', 'free throw percentage': 'ft_pct', 'offensive rebounds per game': 'orb_per_g', 'defensive rebounds per game': 'drb_per_g', 'total rebounds per game': 'trb_per_g', 'assists per game': 'ast_per_g', 'steals per game': 'stl_per_g', 'blocks per game': 'blk_per_g', 'turnovers per game': 'tov_per_g', 'personal fouls per game': 'pf_per_g', 'points per game': 'pts_per_g'}
